...
@section('content')
    ...
    <main>
        ...
        <div class="control-button top">
            <a href="{{url("")}}" class="btn-tambah-so">
                <i class="fa-solid fa-plus"></i>
                <span class="text">Tambah Sales Office</span>
            </a>
            <a href="#" class="btn-import-so"  data-bs-toggle="modal" data-bs-target="#importModal">
                <i class="fa-solid fa-file-import"></i>
                <span class="text">Import Sales Office</span>
            </a>
        </div>
